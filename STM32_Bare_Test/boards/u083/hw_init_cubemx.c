/* hw_init_cubemx.c - STM32U083RC (NUCLEO-U083RC), CubeMX/HAL board init
 *
 * Copyright (C) 2026 wolfSSL Inc.
 *
 * Mirrors boards/u083/hw_init.c: switch MSI 4 MHz default to HSI 16 MHz.
 *   USART2 on PA2 (TX) / PA3 (RX) AF7 -- ST-LINK V2-1 VCP.
 *   HSI48 enabled for RNG kernel clock.
 *   Cortex-M0+, TinyAES + RNG only (no HASH / PKA / SAES).
 */
...
const char *board_name(void) { return "NUCLEO-U083RC (CubeMX/HAL)"; }
