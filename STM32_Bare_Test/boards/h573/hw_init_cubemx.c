/* hw_init_cubemx.c - STM32H573ZI (NUCLEO-H573ZI), CubeMX/HAL board init
 *
 * Copyright (C) 2026 wolfSSL Inc.
 *
 * Mirrors boards/h573/hw_init.c: HSI 64 MHz SYSCLK (no PLL).
 *   USART3 on PD8 (TX) / PD9 (RX) AF7 -- ST-LINK V3 VCP.
 *   H573 has TinyAES + HASH + RNG + V2 PKA + SAES + DHUK.
 */
...
const char *board_name(void) { return "NUCLEO-H573ZI (CubeMX/HAL)"; }
