/* hw_init_cubemx.c - STM32L552ZE-Q (NUCLEO-L552ZE-Q), CubeMX/HAL board init
 *
 * Copyright (C) 2026 wolfSSL Inc.
 *
 * Mirrors boards/l552/hw_init.c: HSI 16 MHz SYSCLK.
 *   LPUART1 on PG7 (TX) / PG8 (RX) AF8 -- needs PWR_VddIO2 release.
 *   LPUART1 kernel clock = PCLK1 (= HSI 16 MHz at this config).
...
static int clock_init_cubemx(void)
{
    ...
    /* Release VddIO2 isolation for Port G high pins. */
...
const char *board_name(void) { return "NUCLEO-L552ZE-Q (CubeMX/HAL)"; }
