/* hw_init_cubemx.c - STM32U545RE-Q (NUCLEO-U545RE-Q), CubeMX/HAL board init
 *
...
/* The wolfssl port_st_stm32.c CUBEMX+PKA path expects the application
 * to provide the PKA handle as a global. We define it here; HAL_PKA_Init
 * is called lazily from wc_stm32_pka_ensure_init() the first time the
 * ECDSA HW path runs. */
...
{
    return "NUCLEO-U545RE-Q (CubeMX/HAL)";
}
