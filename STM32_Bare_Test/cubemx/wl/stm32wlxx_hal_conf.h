/* stm32wlxx_hal_conf.h - minimal CubeMX HAL config for NUCLEO-WL55JC
 *
 * Copyright (C) 2026 wolfSSL Inc.
 *
 * WL55 has TinyAES + RNG + V1 PKA on the M4 side (no HASH). HAL_HASH
 * therefore NOT enabled. PKA HAL is here but wolfssl gates PKA on
 * BUILD_BARE only so cubemx + WL55 falls back to SW math for ECC.
 */
