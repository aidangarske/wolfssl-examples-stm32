/* stm32wbaxx_hal_conf.h - minimal CubeMX HAL config for NUCLEO-WBA52CG
 *
 * Copyright (C) 2026 wolfSSL Inc.
 *
 * Enables the HAL modules wolfcrypt's WOLFSSL_STM32_CUBEMX path needs
 * on WBA silicon (TinyAES via SAES + HASH + RNG + V2 PKA + DHUK), plus
 * the standard board-bringup set.
 */
